...
/***/ function(module, exports, __webpack_require__) {
	...
	var createProfile = function createProfile(id) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signUpSuccess = function signUpSuccess(data) {
	  ...
	  app.user = data.user;
	  var id = app.user.id;
	  api.createProfile(id).done(profilecreated).fail(failure);
	...
	var profileCreated = function profileCreated(data) {
	...
	var getProfile = function getProfile(data) {
	  return $.ajax({
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  getProfile(data).done(profileCreated).fail(failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var singleEventListing = __webpack_require__(11);

	var viewEvents = function viewEvents(event) {
	  event.preventDefault();
	  $('.content').empty();
	  $('.jumbotron').hide();
	  api.showEvents().done(ui.showEvents).fail(ui.failure);
	  api.showMyEvents().done(ui.showMyEvents).fail(ui.failure);
	};
	...
	var createEvent = function createEvent(event) {
	  ...
	  $('.jumbotron').hide();
	  var data = getFormFields(event.target);
	  api.createEvent(data).done(ui.eventCreated).fail(ui.eventFailure);
	  $('#event-notes').empty();
	};

	var viewItems = function viewItems(event) {
	  event.preventDefault();
	  $('.content').empty();
	  $('.jumbotron').hide();
	  api.showItems().done(ui.showItems).fail(ui.failure);
	};

	var searchEvents = function searchEvents(event) {
	  event.preventDefault();
	  $('.content').empty();
	  $('#welcome').empty();
	  // $('.jumbotron').show();
	...
	var deleteEvent = function deleteEvent(event) {
	  ...
	  api.deleteEvent(data).done(ui.deleteEventSuccess).fail(ui.failure);
	  $(event.target).parent().hide();
	};

	var setEventId = function setEventId(event) {
	...
	var setEventIdForSharing = function setEventIdForSharing(event) {
	  var id = $(event.target).data("id");
	  $('#invite-email').val('');
	  ...
	  ui.listInvites(id).done(ui.allFriendsInvited).fail(ui.failure);
	};
	...
	var addItem = function addItem(event) {
	  ...
	  $('#item-notes').empty();
	  var data = getFormFields(event.target);
	  api.addItem(data).done(ui.itemAdded).fail(ui.itemFailure);
	};

	var inviteFriend = function inviteFriend(event) {
	  event.preventDefault();
	  var profile = $(event.target).data("id");
	  var eventid = $('#invite-event-id').val();
	  var data = { "profileId": profile, "eventId": eventid };
	  $('#event-notes').empty();
	  api.inviteFriend(data).done(ui.friendInvited).fail(ui.itemFailure);
	};

	var viewEvent = function viewEvent(event) {
	  event.preventDefault();
	  var data = $(event.target).data("id");
	  api.showEvent(data).done(ui.eventSelected).fail(ui.eventFailure);
	};

	var deleteItem = function deleteItem(event) {
	  event.preventDefault();
	  var data = $(event.target).parent().data("id");
	  api.deleteItem(data).done(ui.deleteItemSuccess).fail(ui.failure);
	  $(event.target).parent().parent().parent().hide();
	};

	var claimItem = function claimItem(event) {
	  var data = $(event.target).data("id");
	  api.claimItem(data).done(ui.claimItemSuccess).fail(ui.failure);
	  $(event.target).parent().html('<h5><span style="color:#236167" class="glyphicon glyphicon-user"></span> You Claimed!</div></h5>');
	};

	var purchaseItem = function purchaseItem(event) {
	  var data = $(event.target).data("id");
	  api.purchaseItem(data).done(ui.purchaseItemSuccess).fail(ui.failure);
	...
	var unclaimItem = function unclaimItem(event) {
	  var data = $(event.target).parent().data("id");
	  api.unclaimItem(data).done(ui.unclaimItemSuccess).fail(ui.failure);
	  $(event.target).parent().parent().parent().hide();
	};

	var unpurchaseItem = function unpurchaseItem(event) {
	  var data = $(event.target).data("id");
	  api.unpurchaseItem(data).done(ui.unpurchaseItemSuccess).fail(ui.failure);
	...
	var searchEventList = function searchEventList() {
	  var data = $('#search-field').val();
	  api.showAllEvents(data).done(ui.showAllEvents).fail(ui.failure);
	};

	var searchUsers = function searchUsers() {
	  event.preventDefault();
	  var data = $('#invite-email').val();
	  api.showAllProfiles(data).done(ui.showAllProfiles).fail(ui.failure);
	};

	var uninvite = function uninvite(event) {
	  event.preventDefault();
	  var data = $(event.target).data("id");
	  api.uninvite(data).done(ui.uninviteSuccess).fail(ui.failure);
	  $(event.target).parent().hide();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showEvents = function showEvents() {
	  return $.ajax({
	...
	var showMyEvents = function showMyEvents() {
	  return $.ajax({
	...
	var showEvent = function showEvent(data) {
	  return $.ajax({
	    url: app.host + "/events/" + data,
	    method: 'GET',
	    dataType: 'json',
	...
	var claimItem = function claimItem(data) {
	  return $.ajax({
	    url: app.host + '/items/' + data,
	    method: 'PATCH',
	    headers: {
	...
	var purchaseItem = function purchaseItem(data) {
	  return $.ajax({
	    url: app.host + '/items/' + data,
	    method: 'PATCH',
	    headers: {
	...
	var unclaimItem = function unclaimItem(data) {
	  return $.ajax({
	    url: app.host + '/items/' + data,
	    method: 'PATCH',
	    headers: {
	...
	var unpurchaseItem = function unpurchaseItem(data) {
	  return $.ajax({
	    url: app.host + '/items/' + data,
	    method: 'PATCH',
	    headers: {
	...
	var showAllEvents = function showAllEvents(data) {
	  return $.ajax({
	...
	var showAllProfiles = function showAllProfiles(data) {
	  return $.ajax({
	...
	var inviteFriend = function inviteFriend(data) {
	  return $.ajax({
	...
	var uninvite = function uninvite(data) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(5);
	var singleEventListing = __webpack_require__(11);
	var myEventsListing = __webpack_require__(31);
	var itemListing = __webpack_require__(32);
	var myItemsListing = __webpack_require__(33);
	var singleItem = __webpack_require__(34);
	var searchEvents = __webpack_require__(35);
	var userListing = __webpack_require__(36);
	var friendsListing = __webpack_require__(37);
	var searchEventsListing = __webpack_require__(38);
	var yourEventsListing = __webpack_require__(39);

	var showEvents = function showEvents(data) {
	  $('.content').append(myEventsListing(data));
	};

	var showMyEvents = function showMyEvents(data) {
	...
	var eventCreated = function eventCreated(data) {
	...
	var eventFailure = function eventFailure(data) {
	...
	var eventSelected = function eventSelected(data) {
	  function isProfileId(p) {
	    if (p.id === app.profile) {
	      return true;
	    };
	  };
	  var arr = data.event.profiles.filter(isProfileId);
	...
	var itemAdded = function itemAdded(item) {
	  $('#add-item-modal').modal('hide');
	  $('#item-table').append(itemListing(item));
	};

	var claimItemSuccess = function claimItemSuccess(data) {};

	var purchaseItemSuccess = function purchaseItemSuccess(data) {};

	var failure = function failure(data) {};

	var unpurchaseItemSuccess = function unpurchaseItemSuccess(data) {};

	var itemFailure = function itemFailure(data) {
	...
	var listInvites = function listInvites(id) {
	  return $.ajax({
	...
	var allFriendsInvited = function allFriendsInvited(data) {
	...
	module.exports = {
	  ...
	  showItems: showItems,
	  unpurchaseItemSuccess: unpurchaseItemSuccess,
	  showAllEvents: showAllEvents,
	  showAllProfiles: showAllProfiles,
	  friendInvited: friendInvited,
	  allFriendsInvited: allFriendsInvited,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <tr>\n    <div class=\"checkbox\" style=\"text-align:left\">\n  <td id=\"claimed\">\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.claimed : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
	    + "  </td>\n    </div>\n    <td><h4>"
	    ...
	    + "</h4></td>\n</td>\n<td><button type=\"button\" class=\"close\" style=\"text-align:center\" id=\"deleteItem\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "><span aria-hidden=\"true\">&times;</span></button>\n</td>\n\n";
	},"2":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "      <!-- <h5 style=\"color:#000\"><span style=\"color:#236167\" class=\"glyphicon glyphicon-user\"></span> You Claimed</h5> -->\n      <h5 style=\"color:#000\"><span style=\"color:#236167\" class=\"glyphicon glyphicon-user\"></span> "
	  ...
	  return "<label>\n      <input type=\"checkbox\" id=\"claim\" data-id="
	    + container.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"id","hash":{},"data":data}) : helper)))
	    + "></label>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "<div id =\"event-listing\">\n\n  <h1>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</h1>\n  <h5><span style=\"color:#000\">Date:</span> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.date : stack1), depth0))
	    + "</h5>\n  <h5><span style=\"color:#000\">Location:</span> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.location : stack1), depth0))
	    + "</h5>\n  <h5><span style=\"color:#000\">Created By:</span> "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.user : stack1)) != null ? stack1.name : stack1), depth0))
	    + "</h5>\n\n  <a href=\"#\" id=\"addItem\" class=\"btn btn-default btn-md\" role=\"button\" data-toggle=\"modal\"\n  data-target=\"#add-item-modal\" data-id="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.id : stack1), depth0))
	    + "><span class=\"glyphicon glyphicon-pushpin\" aria-hidden=\"true\"></span> Add Items</span></a>\n\n  <a href=\"#\" id=\"invite-button\" class=\"btn btn-default btn-md\" role=\"button\" data-toggle=\"modal\"\n  data-target=\"#invite-friends-modal\" data-id="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.id : stack1), depth0))
	    + "><span class=\"glyphicon glyphicon-user\" aria-hidden=\"true\"></span> Invite Friends</span></a>\n\n  <button class='btn btn-md btn-default' onClick=\"window.print()\"><span class=\"glyphicon glyphicon-print\" aria-hidden=\"true\"></span> Print List</button>\n\n\n\n  <h3>Item List:</h3>\n  <table class=\"table table-hover\" id=\"item-table\">\n    <tr>\n      <td><h4 style=\"color:#000; text-decoration: underline\">Claim Item</h4></td>\n      <td><h4 style=\"color:#000; text-decoration: underline\">Item Name</h4></td>\n      <td><h4 style=\"color:#000; text-decoration: underline\">Quantity</h4></td>\n      <td><h4 style=\"color:#000; text-decoration: underline\">Delete</h4></td>\n    </tr>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.items : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "  </tr>\n  </table>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return "<br /><h2 style=\"color:#A9A9A9; font-weight:300;\">Events You've Been Invited To</h2>";
	  ...
	  return "<div id =\"event-listing\">\n  <h1>"
	    ...
	    + "</h5>\n  <h5><span style=\"color:#000\">Created By:</span> "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.user : stack1)) != null ? stack1.name : stack1), depth0))
	    + "</h5>\n  <button class='btn btn-md btn-default' id=\"selectEvent\" data-id="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.id : stack1), depth0))
	    + ">Select</button>\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, options, alias1=depth0 != null ? depth0 : {}, buffer = 
	  ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.sharings : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n";
	  stack1 = ((helper = (helper = helpers.sharings || (depth0 != null ? depth0.sharings : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"sharings","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(alias1,options) : helper));
	  if (!helpers.sharings) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <tr>\n    <div id=\"checkdiv\">\n    <div class=\"checkbox\" style=\"text-align:center\">\n  <td id=\"purchased\">\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.purchased : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
	    + "  </td>\n    </div>\n  </div>\n    <td><h4>"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</h4></td>\n    <td><h4>"
	    + alias4(((helper = (helper = helpers.unit || (depth0 != null ? depth0.unit : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"unit","hash":{},"data":data}) : helper)))
	    + "</h4></td>\n    <td id=\"item-event-name\"><h4 style=\"color:#000\">"
	    + alias4(container.lambda(((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</h4></td>\n<td><button type=\"button\" class=\"close\" style=\"text-align:center\" id=\"unclaimItem\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "><span aria-hidden=\"true\">&times;</span></button>\n</td>\n\n";
	},"2":function(container,depth0,helpers,partials,data) {
	    var helper;

	  return "    <h5 style=\"color:#000\"><span style=\"color:#236167\" id=\"unpurchase\" data-id="
	    + container.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"glyphicon glyphicon-ok\"></span></h5>\n    ";
	},"4":function(container,depth0,helpers,partials,data) {
	    var helper;

	  return "<label>\n    <input type=\"checkbox\" id=\"purchase\" data-id="
	    + container.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"id","hash":{},"data":data}) : helper)))
	    + "></label>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  "<div id=\"item-listing\">\n  <h1>Item List</h1>\n  <!-- <a href=\"#\" id=\"addItem\" class=\"btn btn-default btn-md\" role=\"button\" data-toggle=\"modal\"\n  data-target=\"#add-item-modal\" data-id="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.id : stack1), depth0))
	    + "><span class=\"glyphicon glyphicon-pushpin\" aria-hidden=\"true\"></span> Add Items</span></a>\n\n  <button class='btn btn-md btn-default' id=\"deleteThis\" data-id="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.id : stack1), depth0))
	    + "><span class=\"glyphicon glyphicon-trash\" aria-hidden=\"true\"></span> Delete Event</button> -->\n <button class='btn btn-md btn-default' onClick=\"window.print()\"><span class=\"glyphicon glyphicon-print\" aria-hidden=\"true\"></span> Print List</button>\n  <table class=\"table table-hover\" id=\"item-table\">\n    <tr>\n      <td><h4 style=\"color:#000; text-align:center; text-decoration: underline\">Purchased?</h4></td>\n      <td><h4 style=\"color:#000; text-align:center; text-decoration: underline\">Item Name</h4></td>\n      <td><h4 style=\"color:#000; text-align:center; text-decoration: underline\">Quantity</h4></td>\n      <td><h4 style=\"color:#000; text-align:center; text-decoration: underline\">Event Name</h4></td>\n      <td><h4 style=\"color:#000; text-align:center; text-decoration: underline\">Unclaim</h4></td>\n    </tr>\n\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<tr>\n  <div class=\"checkbox\" style=\"text-align:left\">\n<td id=\"purchased\">\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.purchased : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
	    + "</td>\n  </div>\n  <td><h4>"
	    + alias3(alias2(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</h4></td>\n  <td><h4>"
	    + alias3(alias2(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.unit : stack1), depth0))
	    + "</h4></td>\n  <td id=\"item-event-name\"><h4 style=\"color:#000\">"
	    + alias3(alias2(((stack1 = ((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.event : stack1)) != null ? stack1.name : stack1), depth0))
	    + "</h4></td>\n<td><button type=\"button\" class=\"close\" style=\"text-align:center\" id=\"unclaimItem\" data-id="
	    + alias3(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "><span aria-hidden=\"true\">&times;</span></button>\n</td>\n</tr>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div id =\"event-listing\">\n  <h1>"
	    ...
	    + "</h5>\n  <h5><span style=\"color:#000\"># of Items:</span> "
	    + alias4(container.lambda(((stack1 = (depth0 != null ? depth0.items : depth0)) != null ? stack1.length : stack1), depth0))
	    + "</h5>\n  <button class='btn btn-md btn-default' id=\"selectEvent\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Select</button>\n  <button class='btn btn-md btn-default' id='deleteThis' data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div id =\"event-listing\">\n  <h4>"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</h4>\n  <h5><span style=\"color:#000\">User ID:</span> "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "</h5>\n  <h5><span style=\"color:#000\">Email:</span> "
	    + alias4(((helper = (helper = helpers.email || (depth0 != null ? depth0.email : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"email","hash":{},"data":data}) : helper)))
	    + "</h5>\n  <input type=\"hidden\" name=\"inviteProfileId\" id=\"invite-profile-id\" value="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">\n  <button class='btn btn-md btn-default' name=\"profileId\" id=\"invite-friend\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Invite</button>\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, options, buffer = "";

	  stack1 = ((helper = (helper = helpers.profiles || (depth0 != null ? depth0.profiles : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"profiles","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
	  if (!helpers.profiles) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
	  if (stack1 != null) { buffer += stack1; }
	  return buffer;
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div id =\"event-listing\">\n  <h4>"
	    ...
	    + "</h5>\n  <button class='btn btn-md btn-default' name=\"uninvite\" id=\"uninvite\" data-id="
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Uninvite</button>\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, options, buffer = "";

	  stack1 = ((helper = (helper = helpers.sharings || (depth0 != null ? depth0.sharings : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"sharings","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
	  if (!helpers.sharings) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
	  if (stack1 != null) { buffer += stack1; }
	  return buffer;
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  stack1 = ((helper = (helper = helpers.events || (depth0 != null ? depth0.events : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"events","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return "<br /><h2 style=\"color:#A9A9A9; font-weight:300\">Events You've Created</h2>";
	},"3":function(container,depth0,helpers,partials,data) {
	    var helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;
	  ...
	  return "<div id =\"event-listing\">\n  <h1>"
	    ...
	    var stack1, helper, options, alias1=depth0 != null ? depth0 : {}, buffer = 
	  ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.events : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n";
	  stack1 = ((helper = (helper = helpers.events || (depth0 != null ? depth0.events : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"events","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(alias1,options) : helper));
	  if (!helpers.events) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
	  if (stack1 != null) { buffer += stack1; }
	  return buffer;
	},"useData":true});
